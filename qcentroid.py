...
def run(input_data: dict, solver_params: dict, extra_arguments: dict) -> dict:
    ...
    try:
        ...
        # Phase 5: Generate additional output files for platform visualization
        try:
            generate_additional_output(input_data, result, "PriorityDispatch_ALNS")
            logger.info("Additional output files generated successfully")
        except Exception as ao_err:
            logger.warning(f"Additional output generation failed (non-fatal): {ao_err}")
